...
function Hero() {
    return (
        <div className="container">
            <div className='p-5 border-bottom' style={{textAlign:"center",opacity:"0.7"}}>
                <h3 className='p-5'>We pioneered the discount broking model in India.<br/>
                    Now, we are breaking ground with our technology.</h3>
            </div>
            <div className="row p-5" style={{opacity:"0.7"}}>
